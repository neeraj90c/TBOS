...
{
    internal class AuthorizeUserPolicyProvider : IAuthorizationPolicyProvider
    {
        const string POLICY_PREFIX = "AuthorizeUser";
        public DefaultAuthorizationPolicyProvider FallbackPolicyProvider { get; }

        public AuthorizeUserPolicyProvider(IOptions<AuthorizationOptions> options)
        {
        ...
        public Task<AuthorizationPolicy> GetPolicyAsync(string policyName)
        {
                ...
                int.TryParse(policyName.Substring(POLICY_PREFIX.Length), out var age))
            {
                ...
                policy.AddRequirements(new AuthorizeUserRequirement(age));
